<script>
    import Twiter from '$lib/components/social/Twiter.svelte'
    import Youtube from '$lib/components/social/Youtube.svelte'
    import Facebook from '$lib/components/social/Facebook.svelte'
</script>
